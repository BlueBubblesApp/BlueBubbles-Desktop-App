                ...
                <div className="ReactionParticipant">
                    ...
                    <div className="aReactionLower">
                        ...
                        <div className="aReactionTypeIcon">
                            <svg className="aDisplayedLove" viewBox="0 0 391.837 391.837">
                                <g transform="translate(80 45) scale(.6)" fill="#ff4557">
                                    <path
            ...
            return (
                <div className="ReactionParticipant">
                    ...
                    <div className="aReactionLower">
                        ...
                        <div className="aReactionTypeIcon">
                            <svg className="aDisplayedLaugh" viewBox="0 0 1000 1000">
                                <g
                                    transform="translate(150 100) scale(.65)"
                                    fill={getComputedStyle(document.getElementById("TitleBarRight")).getPropertyValue(
                                        "--sub-title-color"
                                    )}
                                >
            ...
            return (
                <div className="ReactionParticipant">
                    ...
                    <div className="aReactionLower">
                        ...
                        <div className="aReactionTypeIcon">
                            <svg className="aDisplayedEmphasize" viewBox="0 0 1000 1000">
                                <g
                                    transform="translate(740 125) scale(-.55,.55)"
                                    fill={getComputedStyle(document.getElementById("TitleBarRight")).getPropertyValue(
                                        "--sub-title-color"
                                    )}
                                >
