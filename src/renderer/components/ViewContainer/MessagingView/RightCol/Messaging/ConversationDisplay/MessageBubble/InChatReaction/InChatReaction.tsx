...
class InChatReaction extends React.Component<Props, unknown> {
    ...
    render() {
        const classname = this.props.isMessageFromMe ? "reactionOnOutgoing" : "reactionOnIncoming";
        let backgroundStyles = {};
        let foregroundStyles = {};

        if (this.props.isMessageFromMe) {
            const x = this.calculateNewX(this.props.offset).toString();
            if (this.props.isReactionFromMe) {
                const bGCol = getComputedStyle(document.getElementById("TitleBarRight")).getPropertyValue(
                    "--background-color"
                );
                backgroundStyles = {
                    fill: "#007aff",
        ...
        if (this.props.reactionType === "love") {
            let transf = "translate(75 90) scale(.5)";
            if (this.props.isMessageFromMe) {
                transf = "translate(65 90) scale(0.5)";
            }
            ...
            return (
                <svg className={classname} style={backgroundStyles} height="42" width="42" viewBox="0 0 500 500">
                    ...
                    <circle cx="71%" cy="72%" r="70" strokeWidth="30" />
                    <circle cx="43%" cy="47%" r="200" strokeWidth="30" />
                    <svg className="aInChatLove" viewBox="0 0 391.837 391.837">
                        <g transform={transf} style={foregroundStyles}>
                            <path
    ...
    c36.032-0.281,69.718,17.842,89.339,48.065C215.674,53.517,249.273,35.441,285.257,35.528z"
        ...
        if (this.props.reactionType === "like") {
            let transf = "translate(540 280) scale(.5)";
            if (this.props.isMessageFromMe) {
                transf = "translate(1910 280) scale(.5) scale(-1, 1)";
            }
...
C654.1641,1099.2389,655.7422,897.9987,654.1641,898.2689z"
        ...
        if (this.props.reactionType === "dislike") {
            let transf = "translate(250 370) scale(.5)";
            if (this.props.isMessageFromMe) {
                transf = "translate(1050 370) scale(.5) scale(-1, 1)";
            }
        ...
        if (this.props.reactionType === "laugh") {
            let transf = "translate(175 210) scale(.5)";
            if (this.props.isMessageFromMe) {
                transf = "translate(675 210) scale(0.5) scale(-1, 1)";
            }
            ...
            return (
                <svg className={classname} style={backgroundStyles} height="42" width="42" viewBox="0 0 500 500">
                    ...
                    <circle cx="71%" cy="72%" r="70" strokeWidth="30" />
                    <circle cx="43%" cy="47%" r="200" strokeWidth="30" />
                    <svg className="aInChatLaugh" viewBox="0 0 1000 1000">
                        <g transform={transf} style={foregroundStyles}>
        ...
        if (this.props.reactionType === "emphasize") {
            let transf = "translate(690 210) scale(-.5,.5)";
            if (this.props.isMessageFromMe) {
                transf = "translate(150 210) scale(-.5,.5) scale(-1, 1)";
            }
            ...
            return (
                <svg className={classname} style={backgroundStyles} height="42" width="42" viewBox="0 0 500 500">
                    ...
                    <circle cx="71%" cy="72%" r="70" strokeWidth="30" />
                    <circle cx="43%" cy="47%" r="200" strokeWidth="30" />
                    <svg className="aInChatEmphasize" viewBox="0 0 1000 1000">
                        <g transform={transf} style={foregroundStyles}>
        ...
        if (this.props.reactionType === "question") {
            let transf = "translate(6.5 7.5) scale(.45,.45)";
            if (this.props.isMessageFromMe) {
                transf = "translate(20 7.5) scale(.45,.45) scale(-1, 1)";
            }
            ...
            return (
                <>
                    <svg className={classname} style={backgroundStyles} height="42" width="42" viewBox="0 0 500 500">
                        <circle cx="93%" cy="90%" r="35" strokeWidth="30" />
                        <circle cx="72%" cy="72%" r="70" strokeWidth="30" />
                        <circle cx="43%" cy="47%" r="200" strokeWidth="30" />
                        <svg className="aInChatQuestion" viewBox="0 0 31.357 31.357" style={foregroundStyles}>
                            <g transform={transf}>
                                <path
