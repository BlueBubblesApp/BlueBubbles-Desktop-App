            ...
            return (
                <svg className={classname} style={backgroundStyles} height="42" width="42" viewBox="0 0 500 500">
                    ...
                    <svg className="aInChatLove" viewBox="0 0 391.837 391.837">
                        <g transform="translate(70 85) scale(.5)" style={foregroundStyles}>
                            <path
        ...
        if (this.props.reactionType === "like") {
            return (
                <svg className={classname} style={backgroundStyles} height="42" width="42" viewBox="0 0 500 500">
                    ...
                    >
                        <g transform="translate(535 280) scale(.5)" style={foregroundStyles}>
                            <path
            ...
            return (
                <svg className={classname} style={backgroundStyles} height="42" width="42" viewBox="0 0 500 500">
                    ...
                    <svg className="aInChatDislike" viewBox="0 0 1567 1640">
                        <g transform="translate(250 360) scale(.5)" style={foregroundStyles}>
            ...
            return (
                <svg className={classname} style={backgroundStyles} height="42" width="42" viewBox="0 0 500 500">
                    ...
                    <svg className="aInChatLaugh" viewBox="0 0 1000 1000">
                        <g transform="translate(165 200) scale(.5)" style={foregroundStyles}>
            ...
            return (
                <svg className={classname} style={backgroundStyles} height="42" width="42" viewBox="0 0 500 500">
                    ...
                    <svg className="aInChatEmphasize" viewBox="0 0 1000 1000">
                        <g transform="translate(685 200) scale(-.5,.5)" style={foregroundStyles}>
                ...
                <>
                    <svg className={classname} style={backgroundStyles} height="42" width="42" viewBox="0 0 500 500">
                        ...
                        <svg className="aInChatQuestion" viewBox="0 0 31.357 31.357" style={foregroundStyles}>
                            <g transform="translate(6.5 6.5) scale(.45,.45)">
                                <path
